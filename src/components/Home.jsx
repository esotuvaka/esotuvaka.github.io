		...
		<>
			...
			>
				<div className="  mx-auto flex h-full max-w-xs flex-col justify-center sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-[1520px]">
					<div
						ref={(el) => (heroDev = el)}
						className="z-10 rotate-0 text-lg font-semibold text-black sm:text-4xl"
					>
						- Frontend Developer -
					</div>
					<h1
					...
					>
						...
						<div
							...
							className="floating3 flex items-center justify-center overflow-hidden rounded-full border-neutral-200 sm:absolute sm:-left-24 sm:top-[-70vh] sm:h-[40rem] sm:w-[40rem] sm:border "
						>
							<Link
								to="contact"
								smooth={true}
