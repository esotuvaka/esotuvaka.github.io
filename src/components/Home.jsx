		...
		<>
			...
			>
				<div className="  mx-auto flex h-full max-w-xs flex-col justify-center sm:max-w-xl md:max-w-2xl lg:w-3/4 lg:max-w-4xl xl:max-w-6xl 2xl:max-w-[1520px]">
					<div
						ref={(el) => (heroDev = el)}
						className="z-10 flex rotate-0 text-lg font-semibold text-neutral-400 sm:text-4xl xl:max-w-[450px]"
					>
						- Full Stack Developer -
					</div>
					<h1
						ref={(el) => (heroName = el)}
						className="z-10 flex text-6xl text-white sm:text-[7rem] xl:max-w-[850px] xl:text-[9rem]"
					>
						Eric Otuvaka
					</h1>
					...
					<p
						ref={(el) => (heroDesc = el)}
						className="z-10 my-4 max-w-[700] text-base text-neutral-400 sm:text-2xl sm:font-semibold md:max-w-[400px] 2xl:max-w-full"
					>
					...
					>
						...
						<div
							...
							className="floating3 2xl-[-70vh] flex items-center justify-center overflow-hidden rounded-full border-neutral-200 hover:border-teal-600 sm:absolute sm:-left-24 sm:top-[-70vh] sm:h-[40rem] sm:w-[40rem] sm:border xl:top-[-60vh] xl:-left-0"
						>
							<Link
								to="contact"
								smooth={true}
					...
					>
						<button className="z-10 my-4 flex animate-pulse items-center justify-center rounded-md border-2 border-white bg-transparent text-white shadow-md shadow-transparent duration-300 hover:animate-none hover:border-neutral-900 hover:bg-neutral-900 hover:text-white hover:shadow-md hover:shadow-neutral-400">
							<Link
								to="projects"
								smooth={true}
								duration={500}
